...
public class QEvent extends EntityPathBase<Event> {
    ...
    private static final long serialVersionUID = -1727544174L;

    public static final QEvent event = new QEvent("event");

    public final StringPath eventAlt = createString("eventAlt");

    public final StringPath eventDetail = createString("eventDetail");
